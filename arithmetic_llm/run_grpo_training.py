...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--max-gen-length", type=int, default=400)
    ...
    parser.add_argument(
        ...
        help="Reward component weights: format process consistency outcome"
    )
    parser.add_argument(
        "--schedule-strategy",
        type=str,
        ...
        default="linear",
        help="Adaptive scheduling strategy (default: linear)"
    )
    parser.add_argument(
        "--schedule-phase1-frac",
        type=float,
        default=0.25,
        help="Fraction of training in Phase 1 / format (default: 0.25)"
    )
    parser.add_argument(
        "--schedule-phase2-frac",
        type=float,
        default=0.50,
        help="Fraction of training in Phase 2 / process (default: 0.50)"
    )
    return parser
